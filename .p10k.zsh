# Generated by Powerlevel10k configuration wizard on 2021-08-26 at 14:58 EDT.
...
() {
  ...
  # ? add date: typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%-m/%d at %I:%M:%S %p}'
  # ? add day: typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%a at %I:%M:%S %p}'
